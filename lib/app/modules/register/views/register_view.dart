            ...
            child: ListView(
              children: [
                ...
                CustomForm(
                  ...
                  validator: (value) {
                    if (value!.isEmpty) {
                      return 'Mohon untuk memasukkan nama';
                    }
                    return null;
                  },
                ),
                ...
                CustomForm(
                  ...
                  validator: (value) {
                    if (value!.isEmpty) {
                      return 'Mohon untuk memasukkan email';
                    }
                    return null;
                  },
                ),
                ...
                Obx(() => CustomForm(
                      ...
                      toggleObsecureText: controller.toggleObscureText,
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'Mohon untuk memasukkan password';
                        }
                        return null;
                      },
                    )),
